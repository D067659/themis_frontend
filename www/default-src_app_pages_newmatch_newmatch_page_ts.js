"use strict";
(self["webpackChunkapp"] = self["webpackChunkapp"] || []).push([["default-src_app_pages_newmatch_newmatch_page_ts"],{

/***/ 1642:
/*!*************************************************!*\
  !*** ./src/app/pages/newmatch/newmatch.page.ts ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "NewmatchPage": () => (/* binding */ NewmatchPage)
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! tslib */ 4929);
/* harmony import */ var _newmatch_page_html_ngResource__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./newmatch.page.html?ngResource */ 9898);
/* harmony import */ var _newmatch_page_scss_ngResource__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./newmatch.page.scss?ngResource */ 4282);
...
let NewmatchPage = class NewmatchPage {
    constructor(formBuilder, apiService, modalController, navParams, alertController, toastController) {
    ...
    ngOnInit() {
        ...
        if (existingMatch) {
            this.apiService.getAllParticipations(this.apiService.currentUser.selectedClub._id, existingMatch._id).subscribe((participations) => {
        ...
        this.matchForm = this.formBuilder.group({
            city: [existingMatch === null || existingMatch === void 0 ? void 0 : existingMatch.city, [_angular_forms__WEBPACK_IMPORTED_MODULE_3__.Validators.required, _angular_forms__WEBPACK_IMPORTED_MODULE_3__.Validators.minLength(4), _angular_forms__WEBPACK_IMPORTED_MODULE_3__.Validators.maxLength(20)]],
            opponent: [existingMatch === null || existingMatch === void 0 ? void 0 : existingMatch.opponent, [_angular_forms__WEBPACK_IMPORTED_MODULE_3__.Validators.required, _angular_forms__WEBPACK_IMPORTED_MODULE_3__.Validators.minLength(4), _angular_forms__WEBPACK_IMPORTED_MODULE_3__.Validators.maxLength(20)]],
            startDate: [existingMatch ? existingMatch.startDate : this.minDate],
            isHome: [(existingMatch === null || existingMatch === void 0 ? void 0 : existingMatch.isHome) ? true : false],
            meetingPoint: [existingMatch === null || existingMatch === void 0 ? void 0 : existingMatch.meetingPoint, [_angular_forms__WEBPACK_IMPORTED_MODULE_3__.Validators.required, _angular_forms__WEBPACK_IMPORTED_MODULE_3__.Validators.minLength(4), _angular_forms__WEBPACK_IMPORTED_MODULE_3__.Validators.maxLength(20)]],
            clubId: [(existingMatch === null || existingMatch === void 0 ? void 0 : existingMatch.clubId) ? existingMatch === null || existingMatch === void 0 ? void 0 : existingMatch.clubId : this.apiService.currentUser.selectedClub._id],
            _id: [existingMatch === null || existingMatch === void 0 ? void 0 : existingMatch._id]
        });
    ...
    submitForm() {
        ...
        if (match._id == null) { // new match
            delete match._id;
            this.apiService.createMatch(match).subscribe((res) => {
                // Add creator to participants, otherwise nobody could see this game due to missing participants
                this.apiService.setParticipationForMatch(res.clubId, res._id, null).subscribe((res) => {
                    this.showSuccess();
            ...
            if (this.matchForm.dirty) {
                this.apiService.updateMatch(match).subscribe((res) => {
                }, (error) => { this.showAlert(error); });
            }
            const newParticipants = this.players.filter(p => p.new);
            for (const participant of newParticipants) {
                this.apiService.askForParticipation(this.apiService.currentUser.selectedClub._id, this.matchForm.controls._id.value, participant._id).subscribe(() => { }, (error) => { this.showAlert(error); });
            }
            this.dismissModal(true);
        }
    }
    setFormattedDate() {
        this.formattedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(this.matchForm.get('startDate').value), 'HH:mm, d. MMM yyyy');
    }
    showAlert(err) {
...
NewmatchPage.propDecorators = {
    datetime: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_8__.ViewChild, args: [_ionic_angular__WEBPACK_IMPORTED_MODULE_7__.IonDatetime,] }]
};
NewmatchPage = (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_8__.Component)({
        selector: 'app-newmatch',
        template: _newmatch_page_html_ngResource__WEBPACK_IMPORTED_MODULE_0__,
        styles: [_newmatch_page_scss_ngResource__WEBPACK_IMPORTED_MODULE_1__]
    })
], NewmatchPage);
...
/* harmony import */ var _startOfUTCISOWeekYear_index_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../startOfUTCISOWeekYear/index.js */ 8607);
/* harmony import */ var _requiredArgs_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../requiredArgs/index.js */ 1170);
...
/* harmony import */ var _lib_getTimezoneOffsetInMilliseconds_index_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../_lib/getTimezoneOffsetInMilliseconds/index.js */ 1110);
...
/* harmony import */ var _lib_defaultLocale_index_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../_lib/defaultLocale/index.js */ 6991);
...
/* harmony import */ var _lib_formatLong_index_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./_lib/formatLong/index.js */ 6719);
