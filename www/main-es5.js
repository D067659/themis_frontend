(function () {
  ...
  (self["webpackChunkthemis_frontend"] = self["webpackChunkthemis_frontend"] || []).push([["main"], {
    ...
    90158: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var routes = [{
        ...
        loadChildren: function loadChildren() {
          return __webpack_require__.e(
          /*! import() */
          "src_app_pages_club_club_module_ts").then(__webpack_require__.bind(__webpack_require__,
          /*! ./pages/club/club.module */
          67671)).then(function (m) {
            return m.ClubPageModule;
          });
        },
        canLoad: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_1__.AuthGuard] // Secure all child pages
        ...
        loadChildren: function loadChildren() {
          return __webpack_require__.e(
          /*! import() */
          "src_app_pages_matches_matches_module_ts").then(__webpack_require__.bind(__webpack_require__,
          /*! ./pages/matches/matches.module */
          73904)).then(function (m) {
            return m.MatchesPageModule;
          });
        },
        canLoad: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_1__.AuthGuard] // Secure all child pages
    ...
    36747: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _angular_common_locales_de__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! @angular/common/locales/de */
      4175);
      /* harmony import */


      var _angular_common_locales_de__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_angular_common_locales_de__WEBPACK_IMPORTED_MODULE_3__);
      ...
      _AppModule = (0, tslib__WEBPACK_IMPORTED_MODULE_5__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_6__.NgModule)({
        ...
        providers: [{
          ...
          useClass: _interceptors_jwt_interceptor__WEBPACK_IMPORTED_MODULE_2__.JwtInterceptor,
          multi: true
        }, {
    ...
    /***/
    95107: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    73986: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    53543: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _JwtInterceptor = /*#__PURE__*/function () {
        function JwtInterceptor(apiService, toastCtrl) {
          _classCallCheck(this, JwtInterceptor);

          this.apiService = apiService;
          this.toastCtrl = toastCtrl; // Used for queued API calls while refreshing tokens
        ...
        _createClass(JwtInterceptor, [{
          ...
          value: function intercept(request, next) {
            ...
            if (this.isInBlockedList(request.url)) {
              ...
              return next.handle(this.addToken(request)).pipe((0, rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.catchError)(function (err) {
          ...
          value: function isInBlockedList(url) {
            ...
            if (url == "".concat(_environments_environment__WEBPACK_IMPORTED_MODULE_0__.environment.api_url, "/login") || url == "".concat(_environments_environment__WEBPACK_IMPORTED_MODULE_0__.environment.api_url, "/register")) {
              return true;
            } else {
              return false;
            }
      ...
      _JwtInterceptor = (0, tslib__WEBPACK_IMPORTED_MODULE_8__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_9__.Injectable)()], _JwtInterceptor);
      /***/
    },
    ...
    5830: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var USER_TOKEN_KEY = 'my-userinfo-token';
      ...
      var _ApiService = /*#__PURE__*/function () {
        function ApiService(http, router) {
          ...
          this.http = http;
          this.router = router; // Init with null to filter out the first value in a guard!
        ...
        _createClass(ApiService, [{
          key: "getClubInformation",
          value: function getClubInformation(clubId) {
            return this.http.get("".concat(this.url, "/api/clubs/").concat(clubId));
          } // Match API Calls

        }, {
          key: "getAllMatches",
          value: function getAllMatches(clubId) {
            return this.http.get("".concat(this.url, "/api/clubs/").concat(clubId, "/matches"));
          } // Participation API Calls

        }, {
          key: "getParticipationForMatch",
          value: function getParticipationForMatch(clubId, matchId) {
            return this.http.get("".concat(this.url, "/api/clubs/").concat(clubId, "/matches/").concat(matchId, "/participations"));
          }
        }, {
          key: "setParticipationForMatch",
          value: function setParticipationForMatch(clubId, matchId, doParticipate) {
            return this.http.put("".concat(this.url, "/api/clubs/").concat(clubId, "/matches/").concat(matchId, "/participations"), {
              clubId: clubId,
              matchId: matchId,
              "hasTime": doParticipate
            });
          ...
          value: function signUp(credentials) {
            return this.http.post("".concat(this.url, "/register"), credentials);
          ...
          value: function login(credentials) {
            ...
            return this.http.post("".concat(this.url, "/login"), credentials).pipe((0, rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.switchMap)(function (user) {
              _this5.currentAccessToken = user.token;
              console.log(user);

              var storeAccess = _capacitor_storage__WEBPACK_IMPORTED_MODULE_1__.Storage.set({
                key: USER_TOKEN_KEY,
                value: JSON.stringify(user)
              });

              return (0, rxjs__WEBPACK_IMPORTED_MODULE_5__.from)(Promise.all([storeAccess]));
            }), (0, rxjs_operators__WEBPACK_IMPORTED_MODULE_6__.tap)(function (_) {
          ...
          value: function logout() {
            ...
            return _capacitor_storage__WEBPACK_IMPORTED_MODULE_1__.Storage.remove({
              key: USER_TOKEN_KEY
            });
          }
        }]);
      ...
      _ApiService = (0, tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_9__.Injectable)({
        providedIn: 'root'
      })], _ApiService);
      /***/
    },
